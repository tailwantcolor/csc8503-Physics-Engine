...
namespace NCL {
	...
	public:
		...
		static bool	OBBTest(const Transform& worldTransformA,const Vector3 A_vertex[],const Transform& worldTransformB, const Vector3 B_vertex[],Vector3& min_axis, int& num , Vector3& BestA, Vector3& BestB);

		static bool OBBResolution_PointAndBox(const Vector3& BestA,const Transform& worldTransformB, const OBBVolume& volumeB, float& min_depth , Vector3& normal,Vector3& localA,Vector3& localB);
